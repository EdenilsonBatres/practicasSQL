CREATE DATABASE SISTEMA_PARQUEOS
...
---
--ALTER TABLE TARIFA DROP FK_TARIFA_VEHICULO
--DROP TABLE TARIFA
...
----
ALTER TABLE DETALLE_ESTACIONAMIENTO DROP FK_DETALLE_TARIFA------------------
...
----
--ALTER TABLE SESION DROP FK_SESION_LOGIN
--DROP TABLE SESION
----
...
-----
ALTER TABLE REGISTRAR_VEHICULO DROP FK_REGISTRAR_ENCARGADO,FK_REGISTRAR_SESION,FK_REGISTRAR_DETALLE_ESTACIONAMIENTO,FK_REGISTRAR_VEHICULO
DROP TABLE REGISTRAR_VEHICULO
-----

---------------------------------------------------------------------------
/*INSERT INTO TARIFA VALUES(2.5)
INSERT INTO DETALLE_ESTACIONAMIENTO VALUES('9:00',5 )
SELECT * FROM TARIFA
